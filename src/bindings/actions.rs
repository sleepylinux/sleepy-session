...
pub(super) const fn statement(action: SemanticAction) -> ActionStatement {
    match action {
        ...
        SemanticAction::WorkspacePrevious => ActionStatement::Native("focus-workspace-previous"),
        SemanticAction::WorkspaceNext => ActionStatement::Native("focus-workspace-next"),
